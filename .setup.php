...
\033[01;31m      _\033[01;33m 
 ...
 }\033[01;31m------------- \033[01;32mIP Konumu tarama\033[01;31m -------------\033[01;37m{
...
EOL;
    ...
    if (file_exists("/usr/bin/ip-tracer") || file_exists("/data/data/com.termux/files/usr/bin/ip-tracer")) {
      echo "\033[01;32m      UnWashed Tracer başarıyla indirildi!!!\033[00m\n";
      echo <<<EOL

\033[01;37m ----------------------------------------------
|         \033[01;36mcommand\033[01;37m       |        \033[01;36mUse\033[01;37m           |
 ----------------------------------------------
| \033[01;32mtrace -m\033[01;37m              | \033[01;33mKendi IP'ni Gösterir\033[01;37m |
...
EOL;
      ...
      echo "\n\n\033[01;31m  İndirme Başarısız!!!\033[00m";
    }
  }
}
$a=new set;
